...
## Communication Setup ⚡ NEW

The firmware uses **dual serial ports** for debugging and control:
- **USB Serial (115200 baud)**: Debug output, configuration, command logging
- **SoftwareSerial A0/A1 (9600 baud)**: RobotLink protocol for robot control

See [SOFTWARESERIAL_WIRING.md](SOFTWARESERIAL_WIRING.md) for complete wiring guide and usage instructions.
